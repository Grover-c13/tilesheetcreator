...
export const Tile = (props: {tileDef: TileDef, ignoreSelection: boolean, displayTileId: boolean}) => {
    ...
    let selectedClass = tileUnderEdit === props.tileDef.tileId && !props.ignoreSelection ? SELECTION_STYLE : ''
